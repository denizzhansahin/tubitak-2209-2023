  ...
  return (
    <ScrollView>
      <View>
        ...
        <Card style={{ margin: 5 }}>
          <Card.Title title="İnternet Sitesi" subtitle="denizhansahin.com"></Card.Title>
          <Card.Actions>
            <Button onPress={() => Linking.openURL('denizhansahin.com')}>İnternet Sitesini Ziyaret Et</Button>
          </Card.Actions>
        </Card>
        <Card style={{ margin: 5 }}>
