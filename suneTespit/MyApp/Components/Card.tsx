...
function CardViewHaber({ zaman, konum, image, link }) {
  ...
  return (
    <Card style={{ margin: 5 }} onPress={() => navigation.navigate('İçerik Detayı', { haber: link })}>
      <Card.Cover source={{uri:gorselUri}} />
      <Card.Title title={zaman.toISOString()} subtitle={konum} />
